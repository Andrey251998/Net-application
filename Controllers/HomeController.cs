...
namespace Space_App_ASP_MVC.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult users()
        {
            ...
            IEnumerable<User> userDtos = _context.GetUsers();
            var mapper = new MapperConfiguration(cfg => cfg.CreateMap<User, Users>()).CreateMapper();
            var users = mapper.Map<IEnumerable<User>, List<Users>>(userDtos);
            return View(users);
